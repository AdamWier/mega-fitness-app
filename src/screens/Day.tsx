...
import {
  Button, Text, Divider, Card, ListItem, withTheme,
} from 'react-native-elements';
import PropTypes from 'prop-types';
import FoodCard from '../components/FoodCard';

const getTotal = (nutrient: string): CallableFunction => (accumulator, currentValue): number => accumulator + currentValue[nutrient];
